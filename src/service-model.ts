...
export default class ServiceModel {
   ...
   */
  public static isValidDbConfig(config: dbConfigInterface): boolean {
   ...
   * sequelize db object
   */
  public static createDb(config: dbConfigInterface): sequelize.Sequelize {
   ...
   */
  public static generatePaginationLinks(
    ...
    const validatedPaginationOptions = joi.validate(
      paginationOptions,
      paginationOptionsJoiSchema
    );
   ...
   */
  constructor(config: dbConfigInterface) {
   ...
   */
  public checkDbConnectivity(): Promise<any> {
    return this.db
      .authenticate()
      .catch(() =>
        Promise.reject(new Error("Unable to connect to the database"))
      );
  }
}
